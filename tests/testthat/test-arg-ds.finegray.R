...
context("ds.finegray::arg formula null")
test_that("formula null",  {
 
    expect_error(dsSurvivalClient::ds.finegray(), "Please provide a formula")
})

context("ds.finegray::arg data null")
test_that("data null",  {
 
    expect_error(dsSurvivalClient::ds.finegray(formula = "ID ~ age"), "Please provide the name of a data.frame in the 'data' parameter")
})
...
context("ds.finegray::arg::shutdown")
