...
context("ds.coxph::arg empty args")
test_that("empty args",  {
 
    expect_error(dsSurvivalClient::ds.coxph(), "argument \"expl_vars\" is missing, with no default")
})
