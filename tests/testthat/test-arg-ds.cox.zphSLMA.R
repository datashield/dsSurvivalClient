...
context("ds.cox.zphSLMA::arg::setup")
...
context("ds.cox.zphSLMA::arg empty args")
test_that("empty args",  {
 
    expect_error(dsSurvivalClient::ds.cox.zphSLMA(), " Please provide a valid name for a server-side Cox proportional hazards model that has been fit to data !")
})
...
context("ds.cox.zphSLMA::arg::shutdown")
...
context("ds.cox.zphSLMA::arg::done")
