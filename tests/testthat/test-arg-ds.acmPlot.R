...
context("ds.acmPlot::arg pred_obj is NULL")
test_that("pred_obj is NULL",  {
 
    expect_error(dsSurvivalClient::ds.acmPlot(pred_obj = NULL), "Please provide a valid prediction object name!")    
})
...
context("ds.acmPlot::arg::shutdown")
